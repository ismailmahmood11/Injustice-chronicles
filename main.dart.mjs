...
_1659: x0 => new WeakRef(x0),
_1660: x0 => x0.deref(),
_1661: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1661(f,arguments.length,x0) }),
_1662: x0 => new FinalizationRegistry(x0),
_1663: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
_1666: Date.now,
...
_1684: () => globalThis.FinalizationRegistry,
_1690: s => JSON.stringify(s),
_1691: s => printToConsole(s),
_1692: a => a.join(''),
_1695: (s, t) => s.split(t),
_1696: s => s.toLowerCase(),
_1697: s => s.toUpperCase(),
_1698: s => s.trim(),
_1699: s => s.trimLeft(),
_1700: s => s.trimRight(),
_1702: (s, p, i) => s.indexOf(p, i),
_1703: (s, p, i) => s.lastIndexOf(p, i),
_1705: Object.is,
